...
public class SignInAct extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (currentUser != null) {
            ...
            Intent loc = new Intent(SignInAct.this, BaseNavigationDrawer.class);
            startActivity(loc);
        }
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    Toast.makeText(SignInAct.this, "Invalid phone credentails", Toast.LENGTH_LONG).show();// todo replace with sneaker

                } else if (e instanceof FirebaseTooManyRequestsException) {
                    //the sms quote of the project has been exceeded
                    // display error of quote exceeded
                    Toast.makeText(SignInAct.this, "Quota exceeded", Toast.LENGTH_LONG).show();// todo replace with sneaker
                }
    ...
    public void onResume() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("UsersReg");
                ...
                if (task.isSuccessful()) {
                    ...
                    if(!Phonenos.containsValue(phoneNumber)) {
                        ...
                        if(mAuth.getCurrentUser()!=null) {
                            ...
                            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("UsersReg");
