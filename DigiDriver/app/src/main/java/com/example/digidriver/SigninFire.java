...
public class SigninFire extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (currentUser != null) {
            ...
            Intent loc = new Intent(SigninFire.this, MapActivityAmb.class);
            startActivity(loc);
        }

        setContentView(R.layout.signinfire);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    Toast.makeText(SigninFire.this, "Invalid phone credentails", Toast.LENGTH_LONG).show();// todo replace with sneaker

                } else if (e instanceof FirebaseTooManyRequestsException) {
                    //the sms quote of the project has been exceeded
                    // display error of quote exceeded
                    Toast.makeText(SigninFire.this, "Quota exceeded", Toast.LENGTH_LONG).show();// todo replace with sneaker
                }
    ...
    public void onResume() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DriversReg").child("Fire");
    ...
    public void startPhoneNumberVerification(String PhoneNum) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                SigninFire.this,  //activity for callbacks
                mCallbacks);
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    if(!Phonenos.containsValue(phoneNumber)) {
                        ...
                        sharedprefeditor.putBoolean("newdriver",true);
                        sharedprefeditor.apply();
                        if(mAuth.getCurrentUser()!=null) {
                            String uid = mAuth.getCurrentUser().getUid();
                            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("DriversReg").child("Fire");
                        ...
                        sharedprefeditor.putString("Phonenum", phoneNumber);
                        sharedprefeditor.putString("Email",Emailid);
                        sharedprefeditor.putBoolean("newdriver",false);
                        sharedprefeditor.apply();
                    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.floatingActionButton:
                ...
                if (!isdeviceconnected(SigninFire.this)) {
                    connecttonetwork();
                }
                checknumber();
                break;
    ...
    public void checknumber(){
        ...
        if(Phonenos.containsValue(phoneNumber)){
            ...
            new BottomDialog.Builder(this)
                    .setTitle("Register!")
                    .setContent("seems like you are new here We couldn't find you in the database.Please, Register with us at the FIRE STATION to save your fire station location.")
    ...
    private  Runnable delayintent1 = new Runnable() {
        ...
        public void run() {
            ...
            Intent loc = new Intent(SigninFire.this, MapActivityFire.class);
            startActivity(loc);
