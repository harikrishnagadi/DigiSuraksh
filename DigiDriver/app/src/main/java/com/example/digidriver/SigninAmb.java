...
public class SigninAmb extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (currentUser != null) {
            ...
            Intent loc = new Intent(SigninAmb.this, MapActivityAmb.class);
            startActivity(loc);
        }
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    Toast.makeText(SigninAmb.this, "Invalid phone credentails", Toast.LENGTH_LONG).show();// todo replace with sneaker

                } else if (e instanceof FirebaseTooManyRequestsException) {
                    //the sms quote of the project has been exceeded
                    // display error of quote exceeded
                    Toast.makeText(SigninAmb.this, "Quota exceeded", Toast.LENGTH_LONG).show();// todo replace with sneaker
                }
    ...
    public void onResume() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DriversReg").child("Ambulance");
    ...
    public void startPhoneNumberVerification(String PhoneNum) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                SigninAmb.this,  //activity for callbacks
                mCallbacks);
                ...
                if (task.isSuccessful()) {
                    ...
                    if(!Phonenos.containsValue(phoneNumber)) {
                        ...
                        if(mAuth.getCurrentUser()!=null) {
                            ...
                            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("DriversReg").child("Ambulance");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.floatingActionButton:
                ...
                if (!isdeviceconnected(SigninAmb.this)) {
                    connecttonetwork();
                }
                checknumber();
                break;
